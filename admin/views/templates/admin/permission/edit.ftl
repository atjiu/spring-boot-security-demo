        ...
        <form role="form" id="form" action="/admin/permission/edit" method="post">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <select name="pid" id="pid" class="form-control">
                ...
                <#list permissions as ppermission>
                  <option value="${ppermission.id?c}"
                          <#if permission.pid == ppermission.id>selected</#if>>${ppermission.description!}</option>
                </#list>
              </select>
            </div>
            <div class="form-group">
              <label for="description">描述</label>
              <input type="text" class="form-control" value="${permission.description!}" id="description"
                     name="description" placeholder="描述, 如: 用户列表">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="${permission.url!}" id="url" name="url"
                     placeholder="URL, 父节点可为空">
            </div>
          </div>
          <!-- /.box-body -->
