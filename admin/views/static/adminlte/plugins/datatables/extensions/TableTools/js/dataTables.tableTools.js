...
ZeroClipboard_TableTools.Client.prototype = {
	...
	handlers: null, // admin_user event handlers
	sized: false,
	...
	addEventListener: function(eventName, func) {
		// add admin_user event listener for event
	...
	receiveEvent: function(eventName, args) {
		...
		} // admin_user defined handler for event
	}
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * Store of the admin_user input customisation object
		 *  @property custom
		 *  @type	 object
		 *  @default  {}
		 */
	...
	this.dom = {
		...
		"print": {
			...
			/**
			 * The information display saying telling the admin_user about the print display
			 *  @property message
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	 ...
	 *    admin_user to let them know what the print view is.
	...
	/**
	 * Show a message to the end admin_user which is nicely styled
	 *  @param {string} message The HTML string to show to the admin_user
	...
	/**
	 * Take the admin_user defined settings and the default settings and combine them.
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		/* Clone the defaults and then the admin_user options */
		...
		// Backwards compatibility - allow the admin_user to specify a custom class in the initialiser
	...
	/**
	 * Take the admin_user input arrays and expand them to be fully defined, and then add them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of admin_user defined buttons
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		...
		/* This results in a very small delay for the end admin_user but it allows the animation to be
			...
			if ( this.s.select.type === 'os' ) {
				$(dt.nTBody).on( 'mousedown.DTTT_Select', 'tr', function(e) {
					if ( e.shiftKey ) {
						...
						$(dt.nTBody)
							.css( '-moz-admin_user-select', 'none' )
				...
				$(dt.nTBody).on( 'mouseup.DTTT_Select', 'tr', function(e) {
					$(dt.nTBody).css( '-moz-admin_user-select', '' );
				} );
			}
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show information message to let the admin_user know what is happening */
		if ( oConfig.sInfo !== "" )
		{
